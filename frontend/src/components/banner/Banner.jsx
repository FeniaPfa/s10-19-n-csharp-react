    ...
    <section className='banner w-[100%] top-0 h-[100vh] flex justify-center items-center content-center'>
      ...
      >
          ...
          <div className='absolute top-0 left-0 w-[100%] h-[100%] flex flex-col-reverse lg:flex-row lg:items-center text-whiteCustom'>
            <section className='w-full h-1/2 lg:w-1/2 lg:h-[100%] flex flex-col justify-center items-start p-[1.5rem] lg:p-[4rem] gap-3 sm:gap-5 lg:gap-6'>
              <h1 className='font-titulo font-bold text-3xl lg:text-5xl'>
                Bienvenido a <span className='text-oranjeCustom'>GreenEats Delivery</span>!!!
              </h1>
              <h3 className='font-parrafo font-bold text-base lg:text-xl'>
                Tu conexión con la comida saludable y sostenible directamente en tu hogar!
              </h3>
              <p className='font-parrafo font-normal text-sm lg:text-lg'>
                Diseñada para satisfacer tus deseos de una alimentación consciente sin comprometer el sabor ni la
                comodidad. Déjanos guiarte a través de un mundo de opciones frescas y nutritivas.
              </p>
            ...
            <section className='bgImage w-[100%] h-1/2 lg:w-1/2 lg:h-[100%]'>
              <img
                ...
                src='https://res.cloudinary.com/dpiwmbsog/image/upload/v1692752160/fitnessMatket/fut_banner35_lvboks.jpg'
                alt='fondo verduras saludables'
              />
            </section>
          </div>
        </SwiperSlide>
        <SwiperSlide className='bg-[#203a0b] relative'>
          <div className='absolute top-0 left-0 w-[100%] h-[100%] flex flex-col-reverse lg:flex-row lg:items-center text-whiteCustom'>
            <section className='w-full h-1/2 lg:w-1/2 lg:h-[100%] flex flex-col justify-center items-start p-[1.5rem] lg:p-[4rem] gap-3 sm:gap-5 lg:gap-6'>
              <h2 className='font-titulo font-bold text-3xl lg:text-5xl'>Explora nuestro menú saludable!!!</h2>
              <h3 className='font-parrafo font-bold text-base lg:text-xl'>
                Sumérgete en un paraíso de opciones que te nutrirán y energizarán.
              </h3>
              <p className='font-parrafo font-normal text-sm lg:text-lg'>
                Desde platos vegetarianos exquisitos hasta creaciones veganas llenas de sabor, nuestra variedad es
                un reflejo de la naturaleza misma.
              </p>

            </section>
            <section className='bgImage w-[100%] h-1/2 lg:w-1/2 lg:h-[100%]'>
              <img
                src='https://res.cloudinary.com/dpiwmbsog/image/upload/v1692752158/fitnessMatket/fut_banner15_qidan5.jpg'
                alt='fondo verduras saludables'
        ...
        <SwiperSlide className='bg-[#c23e1a] relative'>
          <div className='absolute top-0 left-0 w-[100%] h-[100%] flex flex-col-reverse lg:flex-row lg:items-center text-whiteCustom'>
            <section className='w-full h-1/2 lg:w-1/2 lg:h-[100%] flex flex-col justify-center items-start p-[1.5rem] lg:p-[4rem] gap-3 sm:gap-5 lg:gap-6'>
              ...
              <p className='font-parrafo font-normal text-sm lg:text-lg'>
                ¿Tienes restricciones alimentarias o preferencias específicas? No hay problema. Hacemos que tu
                comida sea tuya en todos los sentidos.
              </p>

            </section>
            <section className='bgImage w-[100%] h-1/2 lg:w-1/2 lg:h-[100%]'>
              <img
                src='https://res.cloudinary.com/dpiwmbsog/image/upload/v1692752156/fitnessMatket/fut_banner03_anbw3p.jpg'
                alt='fondo verduras saludables'
                className='w-[100%] h-[100%] object-cover'
              />
            </section>
