  ...
  return (
    <>
      {loading ? (
          ...
          >
            {filteredData[0]?.data.map((food, index) => {
              return (
                <SwiperSlide
                  key={index}
                  className="swipperSlider pt-0 h-[100%] flex justify-center items-center content-center"
                >
        ...
        <div className="w-[100%] h-[340px] grid place-content-center">
          <p className="text-center font-normal text-marronCustom text-[1.2rem] leading-[30px] tracking-[0.2px]">
