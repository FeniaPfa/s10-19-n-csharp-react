  ...
  return (
    <div className="bg-white text-black">
      <div className="px-5 py-10 max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-bold text-center py-14">
          Producto del día
        </h2>
        ...
        <div className="lg:flex gap-x-20">
          ...
          <div className="border shadow-2xl p-10 flex flex-col gap-y-5 rounded-xl my-20 max-w-xl mx-auto lg:w-1/2">
            ...
            <p className="text-zinc-500 text-base">
              ¡Descubre nuestras ensaladas! Creadas con los ingredientes más
              crujientes y coloridos, nuestras ensaladas son una explosión de
              sabores y nutrientes.¡La opción perfecta para mantener tu
              bienestar sin sacrificar el sabor! ¿Por qué esperar? ¡Ordéna hoy y
              disfruta de una ensalada que te hará sentir bien por dentro y por
              fuera!
            </p>
