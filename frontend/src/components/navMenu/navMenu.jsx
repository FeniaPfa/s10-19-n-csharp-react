    ...
    <>
      <nav className="navMenu w-[170px] px-1 lg:px-auto lg:w-auto flex flex-col justify-center items-start gap-3 lg:flex lg:flex-row lg:justify-start lg:items-center lg:content-center lg:gap-5 text-[1.2rem]">
        ...
        >
          home
          <span
            className={`h-[5px] rounded-[30px]  bg-primary absolute -bottom-1 transition-all duration-200 ease-in ${
              activeIndex === 'home' ? 'w-[100%]' : 'w-0'
            }`}
          />
        </Link>
        <Link
        ...
        >
          ...
          <span
            className={`h-[5px] rounded-[30px]  bg-primary  absolute -bottom-1 transition-all duration-200 ease-in ${
              activeIndex === 'restaurant' ? 'w-[100%]' : 'w-0'
            }`}
          />
        </Link>
        <Link
        ...
        >
          ...
          <span
            className={`h-[5px] rounded-[30px]  bg-primary absolute -bottom-1 transition-all duration-200 ease-in ${
              activeIndex === 'category' ? 'w-[100%]' : 'w-0'
            }`}
          />
        </Link>
        <Link
        ...
        >
          ...
          <span
            className={`h-[5px] rounded-[30px]  bg-primary  absolute -bottom-1 transition-all duration-200 ease-in ${
              activeIndex === 'contacto' ? 'w-[100%]' : 'w-0'
            }`}
          />
        </Link>
      </nav>
