...
const NotFound = () => {
  return (
    <section className="w-full max-h-full h-[calc(100vh-100px)] mt-0 flex flex-col justify-center items-center bg-greenCustom gap-3">
      <h1 className="font-title text-[100px] font-bold text-whiteCustom1">
        404{' '}
      </h1>
      <h2 className="font-parrafo text-[22px] font-semibold text-whiteCustom1">
        Opps! That page can't be found
      </h2>
      <p className="font-parrafo text-[18px] font-normal text-whiteCustom1">
